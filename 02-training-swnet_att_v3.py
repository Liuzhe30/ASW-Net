...
import utils.fixed_att_SWnet_v3
import utils.data_provider_noillumination
...
train_gen = utils.data_provider_noillumination.random_sample_generator(
...
val_gen = utils.data_provider_noillumination.single_data_from_images(
     config_vars["normalized_images_dir"],
     config_vars["boundary_labels_dir"],
...
# build model
model = utils.fixed_att_SWnet_v3.get_model_3_class(config_vars["crop_size"], config_vars["crop_size"], activation=None)
model.summary()
