...
def attention_3d_block_and_concate(down_layer):
    ...
    output_attention_mul = multiply([down_layer, a_probs])
...
def get_core(dim1, dim2):
    ...
    # a layer returns a list of weight values from numpy arrays
     # DOWN 1
...
def get_model_4_class(dim1, dim2, activation="softmax"):
    
    [x, y] = get_core(dim1, dim2)

    y = keras.layers.Convolution2D(4, 1, 1, **option_dict_conv)(y)
